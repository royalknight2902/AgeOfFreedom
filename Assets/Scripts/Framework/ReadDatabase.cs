...
public class ReadDatabase
{
    ...
    void readDragonItem()
    {
        ...
        foreach (XmlNode infoDragonItem in listDragonItems)
        {
            ...
            {
                dragonItemData.Options[0] = float.Parse(infoOption.SelectSingleNode("AtkDamage").InnerText);
                dragonItemData.Options[1] = float.Parse(infoOption.SelectSingleNode("Defense").InnerText);
